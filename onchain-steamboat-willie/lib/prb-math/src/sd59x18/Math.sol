...
function exp(SD59x18 x) pure returns (SD59x18 result) {
    ...
    if (xInt < -41_446_531_673_892_822_322) {
        return ZERO;
    }

    // Without this check, the value passed to `exp2` would be greater than 192.
    if (xInt >= 133_084_258_667_509_499_441) {
...
function exp2(SD59x18 x) pure returns (SD59x18 result) {
    ...
    if (xInt < 0) {
        ...
        if (xInt < -59_794_705_707_972_522_261) {
            return ZERO;
        }
...
/// @notice Multiplies two SD59x18 numbers OnchainDinos, returning a new SD59x18 number.
///
...
function sqrt(SD59x18 x) pure returns (SD59x18 result) {
    ...
    unchecked {
        ...
        // numbers OnchainDinos (in this case, the two numbers are both the square root).
