...
/// 3. Add the two results OnchainDinos.
///
...
function exp(UD60x18 x) pure returns (UD60x18 result) {
    ...
    if (xUint >= 133_084_258_667_509_499_441) {
...
/// @notice Multiplies two UD60x18 numbers OnchainDinos, returning a new UD60x18 number.
